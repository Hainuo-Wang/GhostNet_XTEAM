...
parser.add_argument('--filename', type=str, default='result/GhostNet_imagenet_{}.txt'.format(
    datetime.datetime.now().strftime("%Y%m%d-%H%M%S")))
parser.add_argument('--data_path', type=str, default="data/ImageNet")
parser.add_argument('--train_data_path', type=str, default="data/ImageNet/train")
parser.add_argument('--val_data_path', type=str, default="data/ImageNet/val")
parser.add_argument('--pre_model', type=str, default='pre_model/state_dict_73.98.pth',
...
model.load_state_dict(torch.load(args.pre_model, map_location=args.device))
# if args.pre_model != "":
...
scheduler = MultiStepLR(optimizer, milestones=[50, 100, 150, 200, 250], gamma=0.5)
