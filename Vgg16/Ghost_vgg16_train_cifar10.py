...
from Vgg16.model.Ghost_Vgg16 import Vgg16_net
...
parser.add_argument('--filename', type=str, default='result/vgg16_CIFAR10.txt')
...
model = Vgg16_net().to(args.device)
