...
from torch.optim.lr_scheduler import MultiStepLR, StepLR, CosineAnnealingWarmRestarts
from torchvision import transforms
from torchvision import datasets
from torch.utils.data import DataLoader
import torch.optim as optim
from tqdm import tqdm
from MutiGPU.Ghost_ResNet import resnet50
...
parser.add_argument('--filename', type=str, default='result/Ghost_ResNet_CIFAR10_{}.txt'.format(
